...
class DS3231Component : public time::RealTimeClock, public i2c::I2CDevice {
 public:
  ...
  void read_time();
  void write_time();
  void set_alarm(DS3231AlarmType alarm_type, uint8_t second, uint8_t minute, uint8_t hour, uint8_t day);
  void set_sqw_mode(DS3231SquareWaveMode mode);
  void reset_alarm(DS3231AlarmNumber alarm_number);
